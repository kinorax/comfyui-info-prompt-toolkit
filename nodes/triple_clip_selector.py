...
class TripleClipSelector(c_io.ComfyNode):
    ...
    def execute(
        ...
        values = resolve_clip_selector_values(
            ...
            sha256_values=[sha256_1, sha256_2, sha256_3],
        )
        ...
        return c_io.NodeOutput(clip, value1, value2, value3)
